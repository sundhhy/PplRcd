...
static	I_dev_Char			*usb_pin_int;
static 	usb_control_t		usb_ctl;
//------------------------------------------------------------------------------
// local function prototypes
//------------------------------------------------------------------------------

static  void Usb_intr( void *arg, int type, int encode);
...
{
	Power_Ch376(1);
	Dev_open(DEVID_GPIO_A10, (void *)&usb_pin_int);
	usb_pin_int->ioctol(usb_pin_int, DEVCMD_SET_IRQHDL, Usb_intr, (void *)NULL);
	return Init_Ch386(DEVID_SPI1);
